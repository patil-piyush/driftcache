    ...
    <div className="dashboard">
      ...
      <header className="header">
        <div className="header-left">
          <div>
            <h1>DriftCache</h1>
            <div className="header-subtitle">System Metrics Dashboard</div>
          </div>
        </div>
      ...
      <div className="stats-row">
        <div className="stat-card">
          ...
          <div className="stat-value">{formatNumber(m.totalRequests)}</div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{(m.hitRatio * 100).toFixed(1)}%</div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{m.latency.p99.toFixed(2)}ms</div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{formatNumber(m.misses)}</div>
      ...
      <div className="charts-grid">
        <div className="chart-card">
          ...
          <div className="chart-subtitle">Keys written per shard (hash ring balance)</div>
          <ShardLoadChart distribution={m.shardDistribution} />
        </div>

        <div className="chart-card">
          <div className="chart-title">Hit / Miss Ratio</div>
          <div className="chart-subtitle">L1 cache vs L2 cache vs misses</div>
          <HitMissRatio l1={m.hits.l1} l2={m.hits.l2} misses={m.misses} hitRatio={m.hitRatio} />
        </div>

        <div className="chart-card">
          <div className="chart-title">Remap Comparison</div>
          <div className="chart-subtitle">Percentage of keys remapped (3 → 4 shards)</div>
          <RemapComparisonChart />
        </div>

        <div className="chart-card">
          <div className="chart-title">Latency Percentiles</div>
          <div className="chart-subtitle">Distribution of request latency (ms)</div>
          <LatencyPercentiles p50={m.latency.p50} p95={m.latency.p95} p99={m.latency.p99} />
        </div>

        {/* Shard Health */}
        <div className="chart-card full-width">
          <div className="chart-title">Shard Health Status</div>
          <div className="chart-subtitle">Real-time node availability</div>
